 ...
 */
public class ServletTracingAutoBundle<T> extends SimpleBundle<T> implements AutomaticBundle<T> {

  private final Logger logger = LoggerFactory.getLogger(ServletTracingAutoBundle.class);
